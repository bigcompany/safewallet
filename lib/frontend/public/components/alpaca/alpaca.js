	...
	Alpaca.registerView ({
		...
		"messages": {
			"zh_CN": {
				...
				"invalidEmail": "&#20234;&#22969;&#20799;&#26684;&#24335;&#19981;&#23545;, ex: info@safewallet.org",
	...
	Alpaca.registerView ({
		...
		"messages": {
			"es_ES": {
				...
				"invalidEmail": "Email address invÃ¡lido, ex: support@safewallet.org",
	...
	Alpaca.registerView ({
		...
		"messages": {
			"fr_FR": {
				...
				"invalidEmail": "Adresse de courriel invalide, ex: info@safewallet.org",
	...
	Alpaca.registerView ({
		...
		"messages": {
            "de_AT": {
                ...
                "invalidEmail": "UngÃ¼ltige e-Mail Adresse, z.B.: info@safewallet.org",
...
(function($) {
    ...
    Alpaca.registerMessages({
        "invalidEmail": "Invalid Email address e.g. info@safewallet.org"
    });
