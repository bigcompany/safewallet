...
wallet.after('withdraw', function (data, next){
  ...
  ledger.create({ ip: data.ip, type: 'withdrawal', transactionID: uuid(), owner: data.owner, currency: data.currency, amount: data.amount, sendTo: "a-b-c-d-1-2-3-4" }, function (err, result) {
