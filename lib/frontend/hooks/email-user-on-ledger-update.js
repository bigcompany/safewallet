...
templates['withdrawal-approved'] = require('fs').readFileSync(__dirname + '/../email/withdrawal-approved.html').toString();
templates['withdrawal-blocked'] = require('fs').readFileSync(__dirname + '/../email/withdrawal-blocked.html').toString();
templates['withdrawal-pending'] = require('fs').readFileSync(__dirname + '/../email/withdrawal-pending.html').toString();
