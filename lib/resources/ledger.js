...
ledger.property('status', { type: "string", required: true, enum: ['pending', 'ready', 'blocked', 'processed'], default: 'pending' });
ledger.property('transactionID', { type: "string", required: true });
ledger.property('sendTo', { type: "string", required: false });
ledger.property('receivedFrom', { type: "string", required: false });
